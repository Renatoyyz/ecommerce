...
<head>
  ...
  <title>Admin Pura Sublimação | Log in</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OU -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Faça login usando Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Faça login usando Google+</a>
    </div>
    <!-- /.social-auth-links -->
